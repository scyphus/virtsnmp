...
usage(const char *prog)
{
    ...
    fprintf(stderr,
            "  -d\t\t\tdump all traffic\n"
            "  -u UUIDFILE\t\t\tThe path to UUID database file\n"
...
main (int argc, char **argv)
{
  ...
  while ((arg = getopt(argc, argv, "du:D:fhHL:"
#ifndef DISABLE_MIB_LOADING
                       "m:M:"
#endif /* DISABLE_MIB_LOADING */
                       "n:"
  ...
  init_globalHandler(uuidfile);
  free(uuidfile);
  init_vmHypervisor();
  init_vmInfo();
  init_vmTable();
  init_vmCpuTable();
  init_vmCpuAffinityTable();
  init_vmStorageTable();
  init_vmNetworkTable();

  /* virtsnmpd will be used to read virtsnmpd.conf files. */
  init_snmp("virtsnmpd");
